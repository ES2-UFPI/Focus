...
### Login e cadastro mais confiáveis

Foram corrigidos problemas que podiam atrapalhar a autenticação e a navegação após entrar ou criar uma conta. Agora o estudante é levado corretamente para a área principal do Focus após concluir esses fluxos.

### Agenda mais estável

Foram corrigidos erros que podiam impedir o carregamento ou a atualização de eventos e sessões. A agenda ficou mais consistente ao buscar dados, atualizar listas e lidar com situações de erro.

### Dados separados por estudante

Disciplinas, eventos, sessões e materiais passaram a respeitar melhor o usuário autenticado. Isso evita que informações de outros estudantes apareçam indevidamente e deixa a experiência mais segura.

### Mensagens e ações corrigidas

Foram ajustados problemas em mensagens de confirmação e notificações do app. Com isso, ações como excluir itens e receber retornos visuais ficaram mais previsíveis.

### Grade semanal ajustada

Foram corrigidos problemas visuais que afetavam o título da semana e a exibição do horário inicial da grade. A visualização semanal ficou mais legível e sem cortes importantes.
